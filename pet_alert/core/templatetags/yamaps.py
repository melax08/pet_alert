...
API_KEY = 'f82184cf-4914-45a8-87f6-1594ed68d104'


@register.simple_tag
def yamaps(raw_address, style="width: 480px; height: 320px;"):
    return mark_safe(
        '<div class="django-yamaps" data-raw-address="{}" style="{}"></div>'.format(raw_address, style))
...
def yamaps_init():
    ...
    yamaps_js = '<script type="text/javascript" src="https://api-maps.yandex.ru/2.1/?apikey={}&lang={}"></script>'.format(API_KEY, lang)
