...
class LostAdViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return self.model.objects.select_related("type", "author").filter(active=True, open=True)
    ...
    def _open_processing(self, request, to_set: bool, error_message: str):
        ...
        ad.open = to_set
        ad.save()
        return Response(self.get_serializer(ad, many=False).data, status=status.HTTP_200_OK)
