    ...
    def test_ads_pages_unauthorized_user(self):
        ...
        status_urls_map = {
            ...
            HTTPStatus.NOT_FOUND: [
                "/aboba",
                reverse("ads:lost_detail", kwargs={"ad_id": self.lost_closed_active_ad.id}),
                reverse("ads:found_detail", kwargs={"ad_id": self.found_closed_active_ad.id}),
                reverse("ads:lost_detail", kwargs={"ad_id": self.lost_open_inactive_ad.id}),
                reverse("ads:found_detail", kwargs={"ad_id": self.found_open_inactive_ad.id}),
                reverse("ads:lost_detail", kwargs={"ad_id": self.lost_closed_inactive_ad.id}),
                reverse(
                    "ads:found_detail",
